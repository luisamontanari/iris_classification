...
class kNN_model(ml_model):
    ...
    def __init__(self, training_data : pd.DataFrame, k : int) :
    ...
    def classify_datapoint(self, datapoint : pd.Series) -> str :
        # calculate euclidean distance to all other datapoints and predict the most frequent class among its k nearest neighbors
